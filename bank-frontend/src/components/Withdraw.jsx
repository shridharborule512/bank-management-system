...
function Withdraw() {
    ...
    const handleSubmit = (e) => {
        ...
        TransactionService.withdraw(form)
            .then(res => {
                setResult(res.data);
        ...
        <div style={styles.page}>
            <div style={styles.card}>
                <div style={styles.header}>
                    ...
                    <p style={styles.subtitle}>Withdraw funds from an account</p>
                </div>
                ...
                {result && (
                    <div style={styles.successBox}>
                        ...
                        <p style={styles.resultText}>Account: <strong>{result.accountNumber}</strong></p>
                        <p style={styles.resultText}>Amount Withdrawn: <strong>₹{result.amount}</strong></p>
...
const styles = {
    ...
    btn:        { backgroundColor: '#dc3545', color: 'white', padding: '13px', border: 'none', borderRadius: '6px', fontSize: '15px', cursor: 'pointer' },
